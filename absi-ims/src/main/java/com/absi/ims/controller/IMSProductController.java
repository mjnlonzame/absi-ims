...
public class IMSProductController {
	...
	public String saveIMSProduct(@Valid @ModelAttribute("imsProduct") IMSProduct imsProduct, BindingResult result, Model model,
	...
	public String editIMSProduct(@RequestParam (value="productId", required=true) long productId, Model model, RedirectAttributes redirectAttributes) {
